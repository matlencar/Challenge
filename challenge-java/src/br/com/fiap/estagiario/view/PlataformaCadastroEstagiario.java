package br.com.fiap.estagiario.view;

import java.util.Scanner;

import br.com.fiap.estagiario.model.Endereco;
import br.com.fiap.estagiario.model.Estagiario;
import br.com.fiap.estagiario.model.Faculdade;
import br.com.fiap.estagiario.model.PerfilComportamental;
import br.com.fiap.estagiario.model.PerfilPessoal;
import br.com.fiap.estagiario.model.PerfilProfissional;
import br.com.fiap.estagiario.model.Telefone;
import br.com.fiap.plataforma.model.Dados;

public class PlataformaCadastroEstagiario {
	...
	public static void main(String[] args) {
		...
		//Instanciando informações do perfil pessoal do estagiario
		PerfilPessoal pessoal = new PerfilPessoal();

		// Instanciando faculdade
		Faculdade faculdade = new Faculdade();
		
		//Instanciando dados de usuario e senha
		...
		System.out.println("Insira um objetivo que deseje alcançar: ");
		String objetivo = leitor.next();
		pessoal.setObjetivo(objetivo);
		
		System.out.println("Me diga uma competencia em que você se destaca: ");
		String competencia = leitor.next();
		pessoal.setCompetencia(competencia);
		...
		//Lendo informações de cadastro - usuario 
		System.out.println("Insira seu nome de usuario: ");
		String usuario = leitor.next();
		acesso.setUsuario(usuario);
		
		//Lendo informações de cadastro - senha
		System.out.println("Insira sua senha: ");
		String senha = leitor.next();
		acesso.setSenha(senha);

		System.out.println();
		System.out.println("\t\t\t\tFormulario da plataforma Challenge");
		System.out.println();
		...
		System.out.println(
				"Linguagem de programação backend que o candidato tem conhecimento: " + profissional.getBackend());
		System.out.println(
				"Linguagem de programação frontend que o candidato tem conhecimento: " + profissional.getFrontend());
